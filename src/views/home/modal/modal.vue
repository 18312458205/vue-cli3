...
<script>
import Icon from 'iview/src/components/icon/index'
import iButton from 'iview/src/components/button/index'
...
import { transferIndex as modalIndex, transferIncrease as modalIncrease } from 'iview/src/utils/transfer-queue'
